...
import { View, Text, FlatList, StyleSheet, TouchableOpacity, Animated, ImageBackground, Image } from 'react-native';
...
const RecordScreen = () => {
    ...
    const [recentRides, setRecentRides] = useState([
      { id: '1', date: '2023-07-20', startLocation: 'Location A', endLocation: 'Location B', fare: '1500 Rs', rating: 4, feedback: 'Great ride!' },
      { id: '2', date: '2023-07-18', startLocation: 'Location C', endLocation: 'Location D', fare: '1200 Rs', rating: 5, feedback: 'Excellent service!' },
      { id: '3', date: '2023-07-16', startLocation: 'Location E', endLocation: 'Location F', fare: '2000 Rs', rating: 3, feedback: 'Could be better.' },
    ...
    return (
      <TouchableOpacity onPress={startBounceInAnimation}>
        <Animated.View style={[styles.rideItemContainer, animatedStyle]}>
          ...
          <Text style={styles.locationText}>{`From: ${item.startLocation}`}</Text>
  ...
  return (
    <ImageBackground source={require('../../assets/Images/7.jpg')} style={styles.backgroundImage}>
